...
docker pull fxlabs/control-plane-ee:$2
docker pull fxlabs/vc-git-skill-bot-ee:$2
docker pull fxlabs/bot-ee:$2
docker pull fxlabs/notification-email-skill-bot-ee:$2
docker pull fxlabs/issue-tracker-github-skill-bot-ee:$2
docker pull fxlabs/issue-tracker-jira-skill-bot-ee:$2
...
sudo openssl req -new -subj "$(echo -n "$SUBJ" | tr "\n" "/")" -key "$SSL_DIR/fxcloud.key" -out "$SSL_DIR/fxcloud.csr" -passin pass:$3
...
docker stack deploy -c fx-security-enterprise-data-ee.yaml $1
sleep 30
...
docker stack deploy -c fx-security-enterprise-control-plane-ee.yaml $1
sleep 60

echo "## DEPLOYING DEPENDENT SERVICES ##"
docker stack deploy -c fx-security-enterprise-dependents-ee.yaml $1
sleep 50
...
docker stack deploy -c fx-security-enterprise-haproxy-ee.yaml $1
sleep 10
docker service ls
sleep 5
echo $1 "SERVICES HAVE BEEN DEPLOYED SUCCESSFULLY!!!"
